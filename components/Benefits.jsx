    ...
    return (
      <div className="bg-gray-900 text-white py-20 mx-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center -mt-8 mb-12">Benefits of xcharge</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800 rounded-lg p-6 relative overflow-hidden">
              ...
              <div className="flex items-center mb-4">
                <div className="w-4 h-4 bg-blue-500 rounded-full mr-3"></div>
                <h3 className="text-xl font-semibold">Efficient xcharge</h3>
              </div>
              <p className="text-gray-400">
              Etiam ac ante nulla. nunc tempor.
              </p>
            ...
            <div className="bg-gray-800 rounded-lg p-6 relative overflow-hidden">
              ...
              <div className="flex items-center mb-4">
                <div className="w-4 h-4 bg-blue-500 rounded-full mr-3"></div>
                <h3 className="text-xl font-semibold">xcharge</h3>
              </div>
              <p className="text-gray-400">
              Etiam ac ante nulla. nunc tempor.
              </p>
